                    ...
                    <Container>
                        ...
                        <Navbar.Collapse id="responsive-navbar-nav">
                            <Nav className="ms-auto navbar-container d-flex align-items-center">
                                <CustomLink className='me-lg-5 mt-3 d-inline-block mt-lg-0' to="/home">Home</CustomLink>
                                <CustomLink className='me-lg-5 mt-3 d-inline-block mt-lg-0' to="/about">About Me</CustomLink>
                                <CustomLink className='me-lg-5 mt-3 d-inline-block mt-lg-0' to="/blogs">Blogs</CustomLink>
                                <CustomLink className='me-lg-5 mt-3 d-inline-block mt-lg-0' to="/checkout">Checkout</CustomLink>
                                {
